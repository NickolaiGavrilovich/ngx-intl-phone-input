...
import {CountryPhoneMask} from './data/country-phone-mask';
...
import {phoneNumberValidator} from "./ngx-intl-phone-input.validator";

@Component({
	// tslint:disable-next-line: component-selector
	selector: 'ngx-intl-phone-input',
	templateUrl: './ngx-intl-phone-input.component.html',
	styleUrls: ['./bootstrap-dropdown.css', './ngx-intl-phone-input.component.css'],
	providers: [
		CountryCode,
		CountryPhoneMask,
		{
			...
			useExisting: forwardRef(() => NgxIntlPhoneInputComponent),
			multi: true,
		},
		{
...
export class NgxIntlPhoneInputComponent implements OnInit, OnChanges {
	...
	mask$: BehaviorSubject<string> = new BehaviorSubject<string>('');
	...
	constructor(private countryCodeData: CountryCode, private countryPhoneMask: CountryPhoneMask) {
	...
	*/
	...
	public onPhoneNumberChange(): void {
		...
		if (this.phoneNumber && typeof this.phoneNumber === 'object') {
			...
			this.phoneNumber = numberObj.number?.startsWith('+') ? numberObj.number : '+' + numberObj.number;
	...
	public generateMask(countryCode: string) {
		if (countryCode) {
			return this.countryPhoneMask.countryPhoneMask.find((mask) => mask.code === countryCode.toUpperCase())?.mask;
		} else {
